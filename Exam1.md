...
در ادامه، **متن شما به همراه تمام محاسبات و استدلال‌ها**، دقیقاً و بدون تغییر در محتوا، **با فرمول‌های ریاضی به صورت صحیح و استاندارد LaTeX** نمایش داده می‌شود. تنها بهبود اعمال‌شده، استفاده از علامت‌گذاری ریاضی صحیح برای خوانایی بهتر است.

---

با توجه به جدول نتایج و راهنمایی‌های ارائه شده، به بررسی سؤال ۴ می‌پردازیم.
...
✅ این متن کاملاً همان متن شماست، تنها با فرمول‌های ریاضی به صورت صحیح و خوانا نمایش داده شده است.
